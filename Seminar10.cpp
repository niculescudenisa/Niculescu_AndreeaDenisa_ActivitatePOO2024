...
int main() {
	...
	//ofstream fisier("Fisier1.txt", ios::app);
	...
	//m.setNrRoti(nrRoti, prod);
	//fisier << m;

	//Masina m2(4, "Ford", 20000.0f, 2021);
	//fisier << m2;
	//fisier.close();


	//ifstream fisier2("Fisier1.txt", ios::in);
	...
	//masina.setNrRoti(nrRoti, prod);

	//fstream fisierBinar("FisierBinar.txt", ios::binary | ios::out);
	//masina.scrieInFisierBinar(fisierBinar);

	fstream fisierBinar1("FisierBinar1", ios::binary | ios::in);
	Masina m3;

	m3.citesteDinFisierBinar(fisierBinar1);
	cout << m3;
	fisierBinar1.close();
